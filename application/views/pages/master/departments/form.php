        ...
        <div class="col-xs-12 col-md-12">
            ...
            <form id="frmDepartments" class="form-horizontal" action="<?=site_url()?>department/add" method="POST" enctype="multipart/form-data">			
				<div class="box-body">
                    ...
                    <label for="fin_department_id" class="col-xs-6 col-md-3 control-label"><?=lang("Department ID")?> #</label>
					...
					<div class="form-group">
                    <label for="fst_department_name" class="col-xs-6 col-md-3 control-label"><?=lang("Department Name")?> *</label>
						<div class="col-xs-6 col-md-9">
...
<script type="text/javascript">
	$(function(){
		...
		$("#btnNew").click(function(e){
			e.preventDefault();
			window.location.replace("<?=site_url()?>master/department/add")
		});
		...
		$("#btnDelete").click(function(e){
			...
			$.ajax({
				url:"<?= site_url() ?>master/department/delete/" + $("#fin_department_id").val(),
			}).done(function(resp){
				//consoleLog(resp);
				$.unblockUI();
				if (resp.message != "")	{
		...
		$("#btnList").click(function(e){
			e.preventDefault();
			window.location.replace("<?=site_url()?>master/department/lizt");
		});
	});
