...
<script type="text/javascript">
    $(function() {
        ...
        $("#select-country").select2({
			width: '100%',
			ajax: {
				url: '<?=site_url()?>master/branch/get_countries',
				dataType: 'json',
				delay: 250,
		...
		$("#select-country").change(function(event){
			...
			$("#select-provinces").select2({
				width: '100%',
				ajax: {
					url: '<?=site_url()?>master/branch/get_provinces/'+$("#select-country").val(),
					dataType: 'json',
					delay: 250,
					processResults: function (data){
						items = [];
		...
		$("#select-district").change(function(event){
			...
			$("#select-subdistrict").select2({
				width: '100%',
				ajax: {
					url: '<?=site_url()?>master/branch/get_subdistrict/'+$("#select-district").val(),
					dataType: 'json',
					delay: 250,
					processResults: function (data){
						items = [];
		...
		$("#select-subdistrict").change(function(event){
			...
			$("#select-village").select2({
				width: '100%',
				ajax: {
					url: '<?=site_url()?>master/branch/get_village/'+$("#select-subdistrict").val(),
					dataType: 'json',
					delay: 250,
					processResults: function (data){
						items = [];
