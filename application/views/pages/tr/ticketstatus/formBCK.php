                ...
                <form id="frmTicket" class="form-horizontal" action="<?= site_url() ?>tr/ticket/add" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6 col-md-4">
                                <select id="select-users" class="form-control select2" style="Width: 100%" name="fin_issued_by_user_id">
                                    <?php
                            ...
                            <div class="col-xs-6 col-md-4">
                                <select id="select-toUser" class="form-control select2" style="Width: 100%" name="fin_issued_to_user_id">
                                    <?php
