...
class Monitoringticket_model extends MY_MODEL {
    ...
    public function get_monitoringticket($arrDepartment){
        ...
        WHERE (b.fin_department_id IN ? OR c.fin_department_id IN ?) AND a.fst_status != 'CLOSED' AND a.fst_status != 'REJECTED' AND a.fst_status != 'VOID' AND a.fst_status != 'TICKET_EXPIRED' ORDER BY a.fdt_ticket_datetime ";
